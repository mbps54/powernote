...
- daily nutrition calories vs target;
- daily protein vs target;
- daily fiber vs target;
- daily nutrition quality score;
- weekly fitness active minutes vs target;
- weekly strength and cardio session counts;
- weekly fitness success percentage and effort score.

Nutrition is displayed daily because food targets reset every day. Fitness is displayed weekly because workout plans normally depend on weekly volume and missed/rest days are expected.
